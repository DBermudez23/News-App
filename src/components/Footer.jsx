...
<footer className="bg-white dark:bg-gray-900 border-t border-slate-200 pt-6">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 lg:-mr-16">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li>
                            <a href="www.linkedin.com/in/daniel-bermudez-1b0408277" className="hover:underline">LinkedIn</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between lg:justify-around">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://github.com/DBermudez23" className="hover:underline">Daniel Bermudez Dev™</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 sm:justify-center sm:mt-0">
                <a href="www.linkedin.com/in/daniel-bermudez-1b0408277" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <FaLinkedin className="size-8 hover:scale-125 duration-200"/>
                    <span className="sr-only">linkedIn</span>
                </a>
                <a href="https://github.com/DBermudez23" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5 hover:scale-125 duration-200">
