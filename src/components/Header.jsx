        ...
        <div className="  border-b dark:border-slate-200 text-center">
            <ul className="w-full">
                {NEWS_CATEGORIES.map((category) => (
                    <li key={category} className="w-full p-6 dark:hover:bg-gray-800 hover:bg-slate-200 dark:bg-gray-900">
                        <Link
                            to={`/${category.label}`}
        ...
        <div className="flex flex-col">
            ...
            {/*DESKTOP LINK TO HOME*/}
                ...
                <form className="flex h-7 items-center lg:gap-60 lg:-mr-16 lg:ml-10 ">
                    <input type="text" placeholder="Search news" onChange={(e) => setSearch(e.target.value)} className="p-0.5 px-1 b rounded-md focus:outline-none hover:scale-105 duration-200 text-slate-800 w-60 lg:w-96 lg:-ml-48 dark:bg-gray-700 dark:text-slate-50"/>
                    {/*SEARCH BUTTON */}
